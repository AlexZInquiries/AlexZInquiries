		...
		case "vtmp":
			return (
				<div className="space-y-6">
					...
					<p className="text-lg">
						Central to our system is LARS (Lamp Arm Robot <i>Something</i>), a robotic avatar designed by the team that serves as a physical proxy to translate remote performers&apos; gestures into meticulously abstracted and meaningful movements. We leverage Qualisys for motion capture, JackTrip for low-latency audio streaming, MaxMSP and Processing for human-to-robot movement mappings, Arduino for robot programming, and 3D fabrication for building custom-designed parts.
					</p>
					<p className="text-lg">
						We conduct pilot studies, including interviews with chamber musicians and surveys for audience members, to explore how mechatronic representations influence ensemble coordination, expressive phrasing, and the overall musical experience for both performers and spectators.
					</p>
					<p className="text-lg">
		...
		case "boulez":
			return (
				<div className="space-y-6">
					...
					<p className="text-lg">
						Dialogue de l&apos;ombre double is a groundbreaking composition featuring a live solo clarinet in dialogue with its pre-recorded, spatialized &quot;shadow&quot; self. The piece innovatively explores the interplay between live performance and electronic manipulation, creating a unique auditory experience that challenges traditional notions of musical dialogue and spatial perception. By leveraging the Web Audio API, we are tackling the technical challenges of faithfully reproducing Boulez&apos;s 6-channel spatialization of clarinet recordings within the browser.
					</p>
					<p className="text-lg">
		...
		case "deep-drawing":
			return (
				<div className="space-y-6">
					...
					<p className="text-lg">
						Our system localizes the sound source of the human drawing in real-time, generating predicted visual outputs projected on top of the artist&apos;s physical drawing. By focusing on these subtle, often ignored noises, we propose an alternative philosophy of human-machine creativity that embraces the aesthetic value of AI&apos;s misinterpretations and errors. These so-called mistakes—moments when the AI&apos;s artistry diverges from that of the human—become integral to the artistic process.
					</p>
					<p className="text-lg">
					...
					<p className="text-lg">
					At the core of our system is a fine-tuned ResNet-50 model implemented in Pytorch and trained on our dataset of four-channel spectrograms and 2D coordinates. Its input and output layers are modified for our specific task, and a Kalman filter is integrated to enhance performance stability. The system captures sound from an audio interface routed to four contact microphones attached to a wooden drawing surface, processes the audio into spectrograms, and generates continuous 2D coordinates that drive a live calligraphic visual display in the browser powered by React and Vite, overlaid with the video capture of the human drawing.
					</p>
					<p className="text-lg">
